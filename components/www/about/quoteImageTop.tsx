...
const QuoteImageTop = ({ props }) => (
	<div className='flex min-h-screen px-0 pt-16 mb-20 c'>
		<div className='flex flex-col-reverse flex-wrap-reverse my-auto w-full items-center sm:flex-wrap'>
			<div className='w-full sm:w-1/2'>
				<Viewport
					className='mt-12 pr-2 animate text-4xl xl:text-6xl'
