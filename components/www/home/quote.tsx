...
const Quote = () => (
	<div
		className={`${styles['wallpaper']} flex flex-row-reverse mt-8 mb-4 lg:my-20 w-full px-0`}
	>
		{/* <div className='flex my-auto w-full sm:flex-wrap'> */}
		{/* <div className='w-full sm:w-1/2'> */}
		<Viewport
			className='text-white my-auto sm:w-5/12 flex flex-col mx-10 lg:mr-32 animate text-right text-4xl xl:text-6xl'
